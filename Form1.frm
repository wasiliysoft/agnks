...
Begin VB.Form frmStart 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(2)   =   "Form1.frx":0000
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Frame1(2)"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Схема"
      TabPicture(3)   =   "Form1.frx":001C
