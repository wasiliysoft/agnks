...
Private Sub Обработка_1()
    ...
    Call AddSensorsData(2, gnDif(5), gnDif(11), gnDif(4), 1.5, 0.95 * agnksConfig.PC, 0)
    gdИР2 = GetMass_2
...
'    gnDif(2) = 1000 ' ДД1.1
'    gnDif(3) = 1000 ' ДД1.2
'    gnDif(4) = 0 ' ДД2.1 Давление в баке машины
'    gnDif(5) = 0 ' ДД2.2  Давление в магистрали Компрессор Акк Авто
